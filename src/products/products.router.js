...
//const listOutOfStockCount = require("./products.controller");

router.route("/").get(controller.list).all(methodNotAllowed);
router.route("/:productId([0-9]+})").get(controller.read).all(methodNotAllowed);//currently broken? Path returns 404
